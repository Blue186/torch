<template>
	<div class="mpvue-picker">
		<div :class="showPicker ? 'pickerMask' : ''" @click.stop="maskClick" catchtouchmove="true"></div>
		<div class="mpvue-picker-content " :class="{'mpvue-picker-view-show':showPicker}">
			...
			<picker-view indicator-style="height:40px; line-height:100px;" class="mpvue-picker-view"
