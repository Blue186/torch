...
/* harmony import */ var _user_vue_vue_type_template_id_80842834_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./user.vue?vue&type=template&id=80842834&scoped=true& */ 25);
...
/* harmony import */ var _user_vue_vue_type_style_index_0_id_80842834_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user.vue?vue&type=style&index=0&id=80842834&lang=scss&scoped=true& */ 29);
...
//
//
var record = function record() {__webpack_require__.e(/*! require.ensure | compoments/volunteerRecords */ "compoments/volunteerRecords").then((function () {return resolve(__webpack_require__(/*! ../../compoments/volunteerRecords.vue */ 93));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var myButton = function myButton() {__webpack_require__.e(/*! require.ensure | compoments/myButton */ "compoments/myButton").then((function () {return resolve(__webpack_require__(/*! ../../compoments/myButton.vue */ 100));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};var _default = { components: { myButton: myButton, record: record }, data: function data() {return { nickname: '志愿者', avatarUrl: '/static/images/department.png' };}, onLoad: function onLoad() {// this.getUserInfo()
  }, methods: { goMyVolunteer: function goMyVolunteer() {uni.navigateTo({ url: '/package3/pages/myVolunteer/myVolunteer' });}, getUserInfo: function getUserInfo() {(0, _index.getUserImformation)().then(function (res) {console.log("用户信息数据", res.data);});}, editInformation: function editInformation() {uni.navigateTo({ url: '/package1/pages/userInformationEdit/userInformationEdit' });}, // 复制账号
    copy: function copy(value) {uni.setClipboardData({ data: value });} } };exports.default = _default;
